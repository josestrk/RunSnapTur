$(function(){
    ...
    geolocalizar();
    document.getElementById("compactar").on('click', function(){compactar()});
    document.getElementById("iniciar").on('click', function(){localStorage.geoMap="[]"; map.removeMarkers(); map.cleanRoute();});
});